...
public class CallForegroundNotification extends ContextWrapper {
    ...
    public void sendRequestIncomingPermissionsNotification(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, id)
                ...
                .setTicker("您收到的来电邀请，请允许权限来通话")
                .setContentText("您收到的来电邀请，请允许权限来通话")
                .setAutoCancel(true)
...
//
    ...
    public void sendIncomingCallNotification(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            clearAllNotification();
            createNotificationChannel();
            Notification notification = getChannelNotificationQ(context);
    ...
    private Notification getChannelNotificationQ(
        ...
        Intent fullScreenIntent = new Intent(context, InviteActivity.class);
